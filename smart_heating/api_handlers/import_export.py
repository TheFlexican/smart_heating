...
async def handle_export_config(hass: HomeAssistant, config_manager: ConfigManager) -> web.Response:
...
async def handle_list_backups(hass: HomeAssistant, config_manager: ConfigManager) -> web.Response:
