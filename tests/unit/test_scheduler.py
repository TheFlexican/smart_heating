...
class TestTimeMatching:
    ...
    def test_is_time_in_midnight_crossing_schedule_from_previous_day(
        self, scheduler: ScheduleExecutor, mock_schedule
    ):
        ...
        assert (
            scheduler._is_time_in_midnight_crossing_schedule_from_previous_day(
...
class TestPresetTemperature:
    ...
    def test_get_preset_temperature_away(
    ...
    def test_get_preset_temperature_global(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule, mock_area_manager
    ):
    ...
    def test_get_preset_temperature_unknown(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule
    ):
...
class TestApplySchedule:
    ...
    async def test_apply_temperature_schedule(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule, mock_schedule
    ):
        ...
        with patch.object(
            scheduler, "_apply_temperature_schedule", new_callable=AsyncMock
        ) as mock_apply:
    ...
    async def test_apply_preset_schedule(
        ...
        with patch.object(
            scheduler, "_apply_preset_schedule", new_callable=AsyncMock
        ) as mock_apply:
            await scheduler._apply_schedule(mock_area_with_schedule, mock_schedule)
    ...
    async def test_apply_temperature_schedule_updates_area(
        ...
        with patch.object(scheduler.area_manager, "async_save", new_callable=AsyncMock):
            ...
            await scheduler._apply_temperature_schedule(
                mock_area_with_schedule, mock_schedule, "climate.test"
            )
...
class TestScheduleChecking:
    ...
    async def test_check_schedules_disabled_area(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule, mock_area_manager
    ):
    ...
    async def test_check_schedules_cache_prevents_reapply(
        ...
        scheduler._last_applied_schedule[TEST_AREA_ID] = (
            f"{TEST_AREA_ID}_{mock_schedule.schedule_id}"
        )
...
class TestSmartNightBoost:
    ...
    async def test_find_first_morning_schedule_none(
...
class TestAreaLogger:
    ...
    async def test_apply_schedule_logs_when_logger_available(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule, mock_schedule
    ):
...
class TestSmartNightBoostEdgeCases:
    ...
    async def test_get_target_time_and_temp_from_schedule_with_temperature(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule
    ):
    ...
    async def test_get_target_time_and_temp_fallback_to_area_target(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule
    ):
    ...
    async def test_get_target_time_and_temp_with_logger(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule
    ):
    ...
    async def test_get_target_time_from_config_returns_none_when_not_configured(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule
    ):
    ...
    async def test_get_target_time_from_config_returns_datetime(
        self, scheduler: ScheduleExecutor, mock_area_with_schedule
    ):
...
class TestGetOutdoorTemperatureEdgeCases:
    ...
    def test_get_outdoor_temperature_no_weather_entity(
    ...
    def test_get_outdoor_temperature_unknown_state(
        self, scheduler: ScheduleExecutor, hass: HomeAssistant, mock_area_with_schedule
    ):
    ...
    def test_get_outdoor_temperature_unavailable_state(
        self, scheduler: ScheduleExecutor, hass: HomeAssistant, mock_area_with_schedule
    ):
    ...
    def test_get_outdoor_temperature_invalid_value(
        self, scheduler: ScheduleExecutor, hass: HomeAssistant, mock_area_with_schedule
    ):
