...
**Calculation**:
- Energy Score = 100 - (heating_time_percentage × temperature_delta_factor × cycle_penalty)
...
- Per-user preference configuration UI
...
- Delta indicators (green/red arrows for better/worse)
